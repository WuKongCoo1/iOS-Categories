...
-(void) setCustomPureColorBadgeValue: (NSString *) value backgroundColor:(UIColor *)backgroundColor widthAndHeight:(CGFloat)widthAndHeight
{
    UIView *v = (UIView *)[self performSelector:@selector(view)];
...
//            [sv removeFromSuperview];
            ...
            UILabel *l = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMinX(sv.frame) / 2, CGRectGetMinX(sv.frame) / 2, widthAndHeight, widthAndHeight)];
